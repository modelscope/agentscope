...
from agentscope.service import bing_search, execute_python_code, \
    retrieve_from_list, query_mysql, summarization
...
class ServiceFactoryTest(unittest.TestCase):
    ...
    def test_bing_search(self) -> None:
        ...
        _, doc_dict = ServiceFactory.get(bing_search,
                                         num_results=3, bing_api_key="xxx")

        self.assertEquals(doc_dict, {
            "type": "function",
            "function": {
                "name": "bing_search",
                "description": "Search question in Bing Search API and return the searching results",
    ...
    def test_enum(self):
        def func(a: str, b, c="test", d: Literal[1, "abc", "d"] = 1) -> int:
            pass
    ...
    def test_exec_python_code(self):
        _, doc_dict = ServiceFactory.get(execute_python_code,
                                         timeout=300,
                                         use_docker=True,
    ...
    def test_retrieval(self):
        _, doc_dict = ServiceFactory.get(retrieve_from_list,
                                         knowledge=[1, 2, 3],
    ...
    def test_sql_query(self):
        _, doc_dict = ServiceFactory.get(query_mysql, database="test",
                                         host="localhost",
    ...
    def test_summary(self):
        _, doc_dict = ServiceFactory.get(summarization,
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "text": {
                            "type": "string",
                            "description": "Text to be summarized by the model."
                        }
                    },
                    "required": [
                        "text"
