        ...
        class i {
            ...
            position(e) {
                ...
                if (this.connection && this.updateConnection(t, n), this.editor_selected && (i = this.canvas_x + -(this.pos_x - t), s = this.canvas_y + -(this.pos_y - n), this.dispatch("translate", {
                    ...
                    e.preventDefault();
                    var i = Math.ceil((this.pos_x - t) * this.precanvas.clientWidth / (this.precanvas.clientWidth * this.zoom)),
                        s = Math.ceil((this.pos_y - n) * this.precanvas.clientHeight / (this.precanvas.clientHeight * this.zoom));
            ...
            zoom_in() {
                this.zoom < this.zoom_max && (this.zoom = (Number(this.zoom) + Number(this.zoom_value)).toFixed(1), this.zoom_refresh())
            }

            zoom_out() {
                this.zoom > this.zoom_min && (this.zoom = (Number(this.zoom) - Number(this.zoom_value)).toFixed(1), this.zoom_refresh())
            }
