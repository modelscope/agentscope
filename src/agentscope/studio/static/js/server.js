...
function deleteDeadServer() {
  const deadServerIds = [];
  if (serversTable) {
    const rows = serversTable.getRows();
...
function loadAgentDetails(serverData) {
  ...
  const serverDetailTitle = serverDetail.querySelector(".server-section-title");
  ...
  const agentMemory = document.getElementById("agent-memory");
...
function loadAgentMemory(serverId, agentId, agentName) {
  const agentMemory = document.getElementById("agent-memory");
  const agentMemoryTitle = agentMemory.querySelector(".server-section-title");
...
function initializeServerPage() {
  ...
  const serverflushBtn = document.getElementById("flush-server-btn");
  serverflushBtn.onclick = function () {
    getServerTableData(flushServerTable);
  };
  const deleteDeadServerBtn = document.getElementById("delete-dead-server-btn");
  deleteDeadServerBtn.onclick = deleteDeadServer;
  const agentflushBtn = document.getElementById("flush-agent-btn");
  agentflushBtn.onclick = function () {
    const serverId = curServerId;
    getAgentTableData(serverId, flushAgentTable);
  };
  const deleteAllAgentBtn = document.getElementById("delete-all-agent-btn");
  deleteAllAgentBtn.onclick = deleteAllAgent;
  const memoryflushBtn = document.getElementById("flush-memory-btn");
