...
function allColumnFilter(data) {
    let searchValue = document.getElementById('runs-search-input').value.toLowerCase();
    ...
    fetch('/api/runs/all')
        ...
        .then(data => {
            var runsTable = new Tabulator("#runs-table", {
                data: data,
                columns: [
                    {title: "Status", field: "status", editor: false, vertAlign:"middle", formatter: renderIconInRunsTable},
                    {title: "ID", field: "id", editor: false, vertAlign:"middle"},
                    {title: "Project", field: "project", editor: false, vertAlign:"middle"},
                    {title: "Name", field: "name", editor: false, vertAlign:"middle"},
                    {title: "Create time", field: "create_time", editor: false, vertAlign:"middle"},
                ],
                layout: "fitColumns",
            })

            // Search logic
            document.getElementById('runs-search-input').addEventListener('input', function(e) {
