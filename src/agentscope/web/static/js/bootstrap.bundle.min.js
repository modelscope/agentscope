...
!function (t, e) {
    ...
    var m = {
        TRANSITION_END: "bsTransitionEnd", getUID: function (t) {
            ...
            var e = p(t).css("transition-duration"),
                n = p(t).css("transition-delay"), i = parseFloat(e),
                o = parseFloat(n);
    ...
    var _ = "button", v = "bs.button", y = "." + v, E = ".data-api",
        b = p.fn[_], w = "active", C = "btn", T = "focus",
        S = '[data-toggle^="button"]', D = '[data-toggle="buttons"]',
        I = 'input:not([type="hidden"])', A = ".active", O = ".btn", N = {
    ...
    function zt(t, e) {
        var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
            i = Ht(10), o = "HTML" === e.nodeName, r = Yt(t), s = Yt(e),
            a = Lt(t), l = Nt(e), c = parseFloat(l.borderTopWidth, 10),
        ...
        modifiers: {
            shift: {
                ...
                order: 200, enabled: !0, fn: function (t, e) {
                    var n = e.offset, i = t.placement, o = t.offsets,
                        r = o.popper, s = o.reference, a = i.split("-")[0],
                        l = void 0;
                ...
                fn: function (t, i) {
                    ...
                    var n = re("transform"), o = t.instance.popper.style,
                        r = o.top, s = o.left, a = o[n];
                    o.top = "", o.left = "", o[n] = "";
                ...
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var o = t.placement.split("-")[0], r = t.offsets,
                        s = r.popper, a = r.reference,
    ...
    var we = "dropdown", Ce = "bs.dropdown", Te = "." + Ce, Se = ".data-api",
        ...
        Ue = "top-start", Be = "top-end", qe = "bottom-start",
        Ke = "bottom-end", Qe = "right-start", Ve = "left-start", Ye = {
            offset: 0,
            flip: !0,
            ...
            return t.toggle = function () {
                ...
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var e = [].slice.call(document.querySelectorAll(je)), n = 0, i = e.length; n < i; n++) {
                    var o = c._getParentFromElement(e[n]), r = p(e[n]).data(Ce),
                        s = {relatedTarget: e[n]};
    ...
    var Ti = "bs.tab", Si = "." + Ti, Di = p.fn.tab, Ii = {
        ...
        Li = "show", xi = ".dropdown", Pi = ".nav, .list-group",
        Hi = ".active", ji = "> li > .active",
