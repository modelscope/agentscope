...
!function (t, e) {
    ...
    var n = function (t) {
        ...
        })), s = {}.propertyIsEnumerable, l = Object.getOwnPropertyDescriptor,
        c = {
    ...
    var _, F, V, D = j.inspectSource, B = o.WeakMap,
    ...
    var tt, et = {
            ...
            (t.exports = function (t, e, r, a) {
                var s = !!a && !!a.unsafe, l = !!a && !!a.enumerable,
                    c = !!a && !!a.noTargetGet;
        ...
        }, gt = {includes: ft(!0), indexOf: ft(!1)}, vt = gt.indexOf,
        bt = function (t, e) {
            var i, n = v(t), o = 0, r = [];
        ...
        }, Tt = Ct.data = {}, It = Ct.NATIVE = "N", At = Ct.POLYFILL = "P",
        $t = Ct, Et = P.f, Rt = function (t, e) {
        ...
        _t = Array.isArray || function (t) {
            ...
            return t
        }, Bt = rt("document", "documentElement"), Lt = W("IE_PROTO"),
        Ht = function () {
        }, Mt = function (t) {
    ...
    var zt = Object.create || function (t, e) {
        ...
        Kt = {
            ...
            var e = 1 == t, i = 2 == t, n = 3 == t, o = 4 == t, r = 6 == t,
                a = 5 == t || r;
            ...
            find: ce(5),
            findIndex: ce(6)
        }, ue = he.forEach, de = W("hidden"), pe = "Symbol",
        fe = Qt("toPrimitive"), ge = et.set, ve = et.getterFor(pe),
        be = Object.prototype, ye = o.Symbol, me = rt("JSON", "stringify"),
        we = P.f, Se = A.f, xe = Kt.f, ke = c.f, Oe = H("symbols"),
        Ce = H("op-symbols"), Pe = H("string-to-symbol-registry"),
    ...
    if (a && "function" == typeof Me && (!("description" in Me.prototype) || void 0 !== Me().description)) {
        ...
        qe.constructor = ze;
        var We = qe.toString, Ge = "Symbol(test)" == String(Me("test")),
            Ke = /^Symbol\((.*)\)[^)]+$/;
        He(qe, "description", {
    ...
    var Ye, Je, Xe = function (t, e, i) {
        ...
        }, Qe = rt("navigator", "userAgent") || "", Ze = o.process,
        ti = Ze && Ze.versions, ei = ti && ti.v8;
    ...
    var ii = Je && +Je, ni = Qt("species"), oi = function (t) {
        ...
        }, ri = Qt("isConcatSpreadable"), ai = 9007199254740991,
    ...
    var Oi = function (t, e) {
        ...
        }, Ci = gt.indexOf, Pi = [].indexOf,
        Ti = !!Pi && 1 / [1].indexOf(1, -0) < 0, Ii = Oi("indexOf");
    ...
    var Ai, $i, Ei, Ri = !r((function () {
        ...
        })), ji = W("IE_PROTO"), Ni = Object.prototype,
    ...
    var Di = {IteratorPrototype: Ai, BUGGY_SAFARI_ITERATORS: Vi},
        ...
        }() : void 0), Hi = Di.IteratorPrototype,
        Mi = Di.BUGGY_SAFARI_ITERATORS, Ui = Qt("iterator"), zi = "keys",
        qi = "values", Wi = "entries", Gi = function () {
            ...
            var s, l, c, u = function (t) {
                ...
                }, d = e + " Iterator", p = !1, f = t.prototype,
                g = f[Ui] || f["@@iterator"] || o && f[o], v = !Mi && g || u(o),
            ...
            return l
        }, Yi = "Array Iterator", Ji = et.set, Xi = et.getterFor(Yi),
    ...
    Rt({
        ...
        slice: function (t, e) {
            var i, n, o, r = v(this), a = ht(r.length), s = pt(t, a),
                l = pt(void 0 === e ? a : e, a);
    ...
    var vn = Math.max, bn = Math.min, yn = 9007199254740991,
    ...
    Rt({
        ...
        splice: function (t, e) {
            var i, n, o, r, a, s, l = Ft(this), c = ht(l.length), h = pt(t, c),
                u = arguments.length;
    ...
    var wn = function (t, e, i) {
        ...
        xn = "[" + Sn + "]", kn = RegExp("^" + xn + xn + "*"),
        On = RegExp(xn + xn + "*$"), Cn = function (t) {
            return function (e) {
                var i = String(g(e));
                return 1 & t && (i = i.replace(kn, "")), 2 & t && (i = i.replace(On, "")), i
            }
        }, Pn = {start: Cn(1), end: Cn(2), trim: Cn(3)}, Tn = wt.f, In = P.f,
        An = A.f, $n = Pn.trim, En = "Number", Rn = o.Number,
        jn = Rn.prototype, Nn = d(zt(jn)) == En, _n = function (t) {
    ...
    var Ln = Object.assign, Hn = Object.defineProperty,
        Mn = !Ln || r((function () {
    ...
    var Wn = {};
    Wn[Qt("toStringTag")] = "z";
    var Gn = "[object z]" === String(Wn), Kn = Qt("toStringTag"),
    ...
    var Qn = Pn.trim, Zn = o.parseFloat,
    ...
    var co = {
        ...
        }, ho = Qt("species"), uo = A.f, po = wt.f, fo = et.set, go = Qt("match"),
        vo = o.RegExp, bo = vo.prototype, yo = /a/g, mo = /a/g,
        wo = new vo(yo) !== yo, So = co.UNSUPPORTED_Y;
    ...
    var Po = RegExp.prototype.exec, To = String.prototype.replace, Io = Po,
        Ao = function () {
            var t = /a/, e = /b*/g;
    ...
    (Ao || Eo || $o) && (Io = function (t) {
        var e, i, n, o, r = this, a = $o && r.sticky, s = so.call(r),
            l = r.source, c = 0, h = t;
    ...
    var jo = "toString", No = RegExp.prototype, _o = No.toString,
        Fo = r((function () {
    ...
    var Ho = function (t) {
        ...
        }, Mo = {codeAt: Ho(!1), charAt: Ho(!0)}, Uo = Mo.charAt,
        zo = "String Iterator", qo = et.set, Wo = et.getterFor(zo);
    Ki(String, "String", (function (t) {
        ...
        } : (t = Uo(i, n), e.index += t.length, {value: t, done: !1})
    }));
    var Go = Qt("species"), Ko = !r((function () {
            ...
            if (!a || !s || "replace" === t && (!Ko || !Yo) || "split" === t && !Jo) {
                var l = /./[o], c = i(o, ""[t], (function (t, e, i, n, o) {
                    return e.exec === Ro ? a && !o ? {
                        ...
                        value: l.call(e, i, n)
                    } : {done: !0, value: t.call(i, e, n)} : {done: !1}
            ...
            return Ro.call(t, e)
        }, er = Math.max, ir = Math.min, nr = Math.floor,
        or = /\$([$&'`]|\d\d?|<[^>]*>)/g, rr = /\$([$&'`]|\d\d?)/g;
    ...
    var sr = Qt("species"), lr = [].push, cr = Math.min, hr = 4294967295,
        ur = !r((function () {
            return !RegExp(hr, "y")
        }));
    ...
    Rt({
        ...
        endsWith: function (t) {
            ...
            var i = arguments.length > 1 ? arguments[1] : void 0,
                n = ht(e.length), o = void 0 === i ? n : zr(ht(i), n),
                r = String(t);
            return Ur ? Ur.call(e, r, o) : e.slice(o - r.length, o) === r
        }
    });
    var Gr = P.f, Kr = "".startsWith, Yr = Math.min, Jr = Lo("startsWith"),
        Xr = !Jr && !!function () {
    ...
    var Qr = {
        getSearchInput: function (e) {
            ...
            for (var h = 0; h < t.length; h++) {
                ...
                try {
                    for (var f, g = t[h][Symbol.iterator](); !(u = (f = g.next()).done); u = !0) {
                        var v = f.value, b = v.rowspan || 1,
                            y = v.colspan || 1, m = i[h].indexOf(!1);
            ...
            var e, i = (e = []).concat.apply(e, Er(t)), n = !0, o = !1,
                r = void 0;
            try {
        ...
        return Ar(t, [{
            key: "initDOM", value: function (t, e) {
                ...
                var i = this.initData(t, this.getNum(e)), n = i.rows.join(""),
                    o = this.checkChanges("data", n),
                    r = this.checkChanges("top", i.topOffset),
                    a = this.checkChanges("bottom", i.bottomOffset), s = [];
            ...
            key: "initData", value: function (t, e) {
                ...
                var i = Math.max((this.clusterRows - 50) * e, 0),
                    ...
                    r = Math.max((t.length - n) * this.itemHeight, 0), a = [],
                    s = i;
                o < 1 && s++;
        ...
        return Ar(e, [{
                ...
                this.header = {
                    ...
                    0 === o && Qr.hasDetailViewIcon(e.options) && (r = '<th class="detail" rowspan="'.concat(e.options.columns.length, '">\n          <div class="fht-cell"></div>\n          </th>')), r && "right" !== e.options.detailViewAlign && n.push(r), t.forEach((function (t, r) {
                        var a = Qr.sprintf(' class="%s"', t.class),
                            s = t.widthUnit, l = parseFloat(t.width),
            ...
            key: "initSort", value: function () {
                var t = this, e = this.options.sortName,
            ...
            key: "onSort", value: function (e) {
                var i = e.type, n = e.currentTarget,
            ...
            key: "onSearch", value: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    i = e.currentTarget, n = e.firedByInitSearchText,
            ...
            key: "updateCellByUniqueId", value: function (t) {
                ...
                (Array.isArray(t) ? t : [t]).forEach((function (t) {
                    var i = t.id, n = t.field, o = t.value,
