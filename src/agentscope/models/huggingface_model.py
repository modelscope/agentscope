...
class HuggingFaceWrapper(ModelWrapperBase):
    ...
    def __init__(self, config_name, model_id, max_new_tokens=512, data_path = None, device = None, local_model_path = None, **kwargs):
        super().__init__(config_name=config_name)
        self.max_new_tokens = max_new_tokens  # Set max_new_tokens as an attribute
    ...
    def __call__(self, input, **kwargs) -> ModelResponse:
        try:
            ...
            outputs = self.model.generate(input_ids.to(self.device), max_new_tokens = self.max_new_tokens, **kwargs)
