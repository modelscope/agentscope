[English Homepage](https://github.com/modelscope/agentscope/blob/v0/README.md) | [中文主页](https://github.com/modelscope/agentscope/blob/v0/README_ZH.md) | [**Tutorial**](https://doc.agentscope.io/v0/en/) | [**Roadmap**](https://github.com/modelscope/agentscope/blob/v0/docs/ROADMAP.md) | [**FAQ**](https://doc.agentscope.io/v0/en/tutorial/faq.html)
...
## 📢 ニュース
- **[2025-07-01]** 新しいバージョンのAgentScopeが開発中です。この新しいバージョンでは、AgentScopeはより強力で柔軟になり、新しいアーキテクチャとより多くの機能を備えています。詳細については、[ロードマップ](https://github.com/modelscope/agentscope/blob/v0/docs/ROADMAP.md)を参照してください！
...
👉👉 [**過去のニュース**](https://github.com/modelscope/agentscope/blob/v0/docs/news_ja.md)
