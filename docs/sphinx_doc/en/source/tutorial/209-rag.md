...
Regarding the last attribute, each entry of the list configures a data
...
More specifically, for `load_data`, you can choose to use a wide collection of data loaders,
    such as `SimpleDirectoryReader` (in `class`) to load a various collection of data types
