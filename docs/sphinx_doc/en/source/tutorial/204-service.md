...
|                             | `NoteBookExecutor.run_code_on_notebook`                  | Compute Execute a piece of Python code, in `ipython` fashion, within the ipython environment of the NoteBookExecutor.                                          |
