# -*- coding: utf-8 -*-
"""
This module manages connections to a server using the Model Context Protocol (
MCP) and facilitates tool execution through that server. It interacts with
MCP servers, lists available tools, and executes specified tools with
arguments.
"""
import asyncio
import os
...
# Note: This code is adapted from the example found at
