...
service_factory.add(bing_search, api_key=BING_API_KEY, num_results=3)
service_factory.add(execute_python_code)
service_factory.add(read_text_file)
service_factory.add(write_text_file)
